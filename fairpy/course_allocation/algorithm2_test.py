...
def test_1(): 
    ...
    assert algorithm2(price_vector, maximum, eps, students, courses, csp_mapping) == [9,10,4.5]
...
def test_2(): 
    ...
    assert algorithm2(price_vector, maximum, eps, students, courses, csp_mapping) == [2.4,8.125,10.4]
...
def test_3():
    ...
    maximum = 6
    price_vector = [3,4,3]
    assert(algorithm2(price_vector, maximum, eps, students, courses, csp_mapping)==[3,6,3])
